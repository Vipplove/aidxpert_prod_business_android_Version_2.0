...
class PathologistProfile extends StatefulWidget {
  final PathologistDashboardController controller;
  const PathologistProfile({super.key, required this.controller});

  @override
  State<PathologistProfile> createState() => _PathologistProfileState();
}

class _PathologistProfileState extends State<PathologistProfile> {
