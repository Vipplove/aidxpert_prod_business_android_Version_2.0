...
class DiagnosticsRegistrationView
    extends GetView<DiagnosticsProviderRegistrationController> {
  DiagnosticsRegistrationView({Key? key}) : super(key: key);
  final GlobalKey<FormState> diagnosticRegisterformKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<DiagnosticsProviderRegistrationController>(
          id: 'diagnostic-form',
          builder: (ctrl) => ctrl.hasLoaded.value == true
              ? Center(child: loading)
              : Form(
                  key: diagnosticRegisterformKey,
                  child: ListView(padding: const EdgeInsets.all(20), children: [
                    ...
                    _buildSectionHeader('Diagnostic Provider Logo'),
        ...
        bottomNavigationBar: Get.arguments['action'] != 'sales'
            ? (type == 'update' || type == 'create'
                ? const DiagnosticProviderBottomNavBar(index: 4)
                : Container(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        ...
                        children: [
                          const TextSpan(
                            text:
                                "We're working on verifying your account! The Aidxpert team will call you soon. Need help right now? ",
                          ),
                          TextSpan(
                            text: "Call Now",
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = () async {
                                ...
                                if (await canLaunchUrl(url)) {
                                  ...
                                  customToast("Cannot open dialer", Colors.red);
                                }
                              },
                          ),
                          const TextSpan(text: "."),
  ...
  Widget _buildFullWidthField({
    ...
    required DiagnosticsProviderRegistrationController ctrl,
  }) {
  ...
  Widget _buildIfscWithBank(DiagnosticsProviderRegistrationController ctrl) =>
      Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildFullWidthField(
  ...
  Widget _buildLogoSection(DiagnosticsProviderRegistrationController ctrl) =>
      Column(
        children: [
...
// Add these two methods to your class
  ...
  Widget _buildAccreditationChips(
      DiagnosticsProviderRegistrationController ctrl) {
    final options = [
      'NABH Accredited',
      'ISO 13485',
      'CAP certified',
  ...
  Widget _buildSubmitButton(
          String type, DiagnosticsProviderRegistrationController ctrl) =>
      Obx(
        () {
          ...
          return SizedBox(
            ...
            child: ElevatedButton(
              onPressed: ctrl.isLoading.value || !canSubmit
                  ? null
                  : () async {
                      if (diagnosticRegisterformKey.currentState?.validate() !=
                          true) {
                      ...
                      if (type == 'update') {
                        ...
                        await ctrl
                            .registerAndContinue(); // Two-step registration
                      }
                    },
              style: ElevatedButton.styleFrom(
