...
diagnosticTestSearch(
  BuildContext context,
  testList,
  subtotal,
  payAmt,
  testData,
  DiagnosticsProviderDashboardController ctrl,
) {
  return showDialog(
    context: context,
              ...
              children: [
                ...
                Card(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      ctrl.getDiagnosticTestList(value);
                    },
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: Obx(() => ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var data = ctrl.diagnosticTestList[index];
...
removeTest(
  ...
  ctrl.update(['diagnostic-test-details']);
}
